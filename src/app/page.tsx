          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-2 hover:border-primary/50 relative overflow-hidden">
            ...
            <CardHeader className="pb-4">
              <div className="w-12 h-12 bg-cyan-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-cyan-200 transition-colors">
                <BookOpenCheck className="w-6 h-6 text-cyan-600" />
              </div>
              <CardTitle className="text-xl">Trello Premium Guide</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                Materi lengkap Trello Premium, AI, dan automation dalam format zero-loss.
              </p>
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Sumber Utama</span>
                  <span className="font-medium">2 dokumen</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Topik</span>
                  <span className="font-medium">11+ section</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">Mode</span>
                  <span className="font-medium text-cyan-700">Zero Loss</span>
                </div>
              </div>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
          ...
          <Link href="/vps-analysis">
            <Card className="hover:border-primary transition-colors cursor-pointer h-full">
              <CardContent className="p-6 flex flex-col items-center text-center">
                <Server className="w-8 h-8 text-violet-600 mb-3" />
                <p className="font-medium">VPS Analysis</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/saas-clone-material">
            <Card className="hover:border-primary transition-colors cursor-pointer h-full">
              <CardContent className="p-6 flex flex-col items-center text-center">
                <BookOpenCheck className="w-8 h-8 text-cyan-700 mb-3" />
                <p className="font-medium">Materi SaaS</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link href="/trello-premium-guide">
            <Card className="hover:border-primary transition-colors cursor-pointer h-full">
              <CardContent className="p-6 flex flex-col items-center text-center">
                <BookOpenCheck className="w-8 h-8 text-cyan-600 mb-3" />
                <p className="font-medium">Materi Trello</p>
              </CardContent>
            </Card>
          </Link>
